      ...
      <div class="col-xs-12 col-sm-9">
        ...
        <div class="panel panel-info dontprint">
          ...
          <div class="panel-body">
           ...
           <div class="row doprint" STYLE=" margin:3mm 3mm 3mm 3mm; border: 3px double #000000; width:185mm; height:130mm;">
              <div class="col-sm-12" style="font-family:'Book Antiqua';  ">
                <div align='center' style=" padding-top:12px; letter-spacing:1px; font-weight: bold;">
                 ...
                 <br/> <span class="data" style="font-family:'Arial'; font-size:1.4em; margin-bottom:12px; letter-spacing: 3px;">BONAFIDE CERTIFICATE</span>
                </div><br/>
                ...
                <div align='right' style="padding-right:15px; font-weight: bold; font-size:1.1em;">
                  <br><br/>
                  PRINCIPAL&emsp;&emsp;&emsp;&emsp;&emsp;
